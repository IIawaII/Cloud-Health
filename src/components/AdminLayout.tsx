...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-slate-900 text-white flex flex-col transition-transform duration-300 lg:translate-x-0 ${
      ...
      >
        ...
        <div className="h-16 flex items-center gap-3 px-6 border-b border-slate-800">
          ...
          <span className="text-lg font-semibold tracking-tight">管理后台</span>
        </div>
        ...
        <div className="p-4 border-t border-slate-800">
          ...
          <button
            ...
            className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-red-400 hover:bg-slate-800 transition-colors"
          >
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-500">
              ...
              <span className="text-slate-800 font-medium">管理后台</span>
            </div>
          </div>
          <button
