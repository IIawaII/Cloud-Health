...
export default function Home() {
  ...
  const highlights = [
    { icon: FiZap, title: t('home.highlights.ai'), desc: t('home.highlights.ai') },
    { icon: FiShield, title: t('home.highlights.privacy'), desc: t('home.highlights.privacy') },
    { icon: FiHeart, title: t('home.highlights.professional'), desc: t('home.highlights.professional') },
  ]
    ...
    <div className="space-y-16">
      ...
      <section className="text-center pt-8 pb-4">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-foreground dark:text-foreground-dark mb-5 tracking-tight">
          {t('home.subtitle').split('健康 AI 顾问')[0]}
